...
class CarrerasControllerTest < ActionController::TestCase
  ...
  test "should create carrera" do
    assert_difference('Carrera.count') do
      post :create, carrera: { Cod_carrera: @carrera.Cod_carrera, Facultad_id: @carrera.Facultad_id, Jefe_carrera: @carrera.Jefe_carrera, Nombre_carrera: @carrera.Nombre_carrera }
    end
  ...
  test "should update carrera" do
    patch :update, id: @carrera, carrera: { Cod_carrera: @carrera.Cod_carrera, Facultad_id: @carrera.Facultad_id, Jefe_carrera: @carrera.Jefe_carrera, Nombre_carrera: @carrera.Nombre_carrera }
    assert_redirected_to carrera_path(assigns(:carrera))
  end
